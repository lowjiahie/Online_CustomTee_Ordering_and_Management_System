    ...
    <div class="row">
      ...
      <div class="col-5 bg-white pt-2 pe-2">
        ...
        <div class="tab-content p-1" id="myTabContent">
          ...
          >
            <div v-show="!showEditText" class="add-text-block">
          ...
          <div class="tab-pane fade" id="shape" role="tabpanel" aria-labelledby="shape-tab">
            <div v-show="!showEditShape" id="add-shape-block">
            ...
            <div v-show="showEditShape" id="edit-shape-block" class="mt-2">
              <!-- 
              - size
              - rotation
              - color fill, stroke
              - storke width
              -->
              <p class="fs-5 fw-bold text-dark mb-0">Edit Shape</p>
              <div class="mb-0">
...
export default {
  ...
  methods: {
    ...
    rotationAngleOnChange(e) {
      maincanvas
        .getActiveObject()
        .set("angle", parseInt(e.target.value, 10))
        .setCoords();
      maincanvas.requestRenderAll();
    },
    fillColorOnChange() {
      ...
      maincanvas
        .getActiveObject()
        .set("fill", String(this.fillHexCode))
        .setCoords();
      maincanvas.requestRenderAll();
    },
    strokeColorOnChange() {
      ...
      maincanvas
        .getActiveObject()
        .set("stroke", String(this.strokeHexCode))
        .setCoords();
      maincanvas.requestRenderAll();
    },
    strokeWidthOnChange(e) {
